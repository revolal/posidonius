...
pub const INTEGRATOR_MIN_DT : f64 = 0.005;             // Minimum timestep used as a floor when adaptive timestepping is enabled (default: 0.).
pub const INTEGRATOR_MAX_DT : f64 = 0.01;             // Maximum timestep used as a ceiling when adaptive timestepping is enabled (default: 0. => disabled).
