...
ax.plot(w_lm_c ,ImK2_c , label='c', color = 'blue')
ax.plot(w_lm_d ,ImK2_d , label='d', color = 'green')
ax.plot(w_lm_e ,ImK2_e , label='e', color = 'yellow')
ax.plot(w_lm_f ,ImK2_f , label='f', color = 'brown')
ax.plot(w_lm_g ,ImK2_g , label='g', color = 'cyan')
ax.plot(w_lm_h ,ImK2_h , label='h', color = 'orange')
ax.set_ylabel(field+" ")
ax.set_yscale('log')
...
ax.plot(w_lm_c ,ReK2_c , label='c', color = 'blue')
ax.plot(w_lm_d ,ReK2_d , label='d', color = 'green')
ax.plot(w_lm_e ,ReK2_e , label='e', color = 'yellow')
ax.plot(w_lm_f ,ReK2_f , label='f', color = 'brown')
ax.plot(w_lm_g ,ReK2_g , label='g', color = 'cyan')
ax.plot(w_lm_h ,ReK2_h , label='h', color = 'orange')
ax.set_ylabel(field+" ")
ax.set_yscale('log')
ax.set_xlabel('Excitative frequency $\sigma$  ($s^{-1}$)')
ax.set_xscale('log')
